...
def extractRBCSavingInfo(text: List[str]) -> List[str]:
    rbcBankInfo = []
...
def extractRBCSavingDirectory(
    ...
    iterateDirectory(
        directoryPath, pageInfo, fileInfo, extractRBCSavingFile, baseDestDirectory
    )
